...
const Home: React.FC = () => {
  ...
  return (
    <AuthGuard>
      <div className="flex flex-col p-2 items-center gap-5 min-h-screen">
          ...
          <div className="text-white">
            <ul>
              <li className="mb-4">
                ...
                Banks set a minimum balance for accounts. This varies based on
                the account type and bank policy.
              </li>
              <li className="mb-4 ">
                <span className="text-green-300 font-bold underline">
                  Penalty Calculation:
              ...
              <li className="mb-4">
                ...
                Banks impose fees for non-maintenance, ranging from fixed
                amounts to a percentage of the shortfall.
              </li>
              <li className="mb-4">
                <span className="text-green-300 font-bold underline">
                  Mitigation Strategies:
                </span>{" "}
                Monitor balances regularly, explore account options, and
                consider services that waive penalties.
              </li>
            </ul>
            <p className="text-base">
              Conclusion: Understanding NMAB penalties helps manage finances
              effectively, avoiding unnecessary charges and maintaining a
              healthy banking relationship.
            </p>
          </div>
        </div>
      </div>
